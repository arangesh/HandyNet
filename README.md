...
## Inference
An example using the HandyNet for inference and visualization can be seen in [this script](https://github.com/arangesh/HandyNet/blob/master/scripts/demo_inference.py).
